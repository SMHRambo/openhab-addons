 ...
 */
package org.openhab.binding.rollershutterautomation.internal.calc;
...
import org.openhab.binding.rollershutterautomation.internal.model.Sun;
import org.openhab.binding.rollershutterautomation.internal.model.SunPhaseName;
import org.openhab.binding.rollershutterautomation.internal.util.DateTimeUtils;
...
public class SunCalc {
    ...
    private Sun getSunInfo(Calendar calendar, double latitude, double longitude, Double altitude,
            boolean onlyRollershutterAutomation, boolean useMeteorologicalSeason) {
        double lw = -longitude * DEG2RAD;
        double phi = latitude * DEG2RAD;
        ...
        if (onlyRollershutterAutomation) {
            return sun;
        }
